...
Order currentOrder;
    ...
    private void btnCheckOutActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCheckOutActionPerformed
       ...
       currentOrder=new Order();
        ...
        JOptionPane.showMessageDialog(this,"Thank you for your purchase.Looking for to see you again!");
    ...
    private void btnModifyQuantityActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModifyQuantityActionPerformed
        ...
        if(selectedRowIndex<0){
            JOptionPane.showMessageDialog(this,"Please select order item first");
            return;
        } 
        ...
        if(item.getProduct().getAvail()+oldQuant<quant){
              JOptionPane.showMessageDialog(this,"Please check  product availibility"); 
              return;
            }
        ...
        if(item==null){
            if(product.getAvail()>=quant){
             ...
             product.setAvail(product.getAvail()- quant);
                ...
                JOptionPane.showMessageDialog(this,"Please check product availbility");
                return;
            }
        }else{
            int oldQuant=item.getQuantity();
            if(item.getProduct().getAvail()+oldQuant<quant){
              JOptionPane.showMessageDialog(this,"Please check the product availibility"); 
              return;
            }
            item.getProduct().setAvail(item.getProduct().getAvail()+oldQuant-quant);
            item.setQuantity(quant);
